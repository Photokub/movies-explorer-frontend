...
export default function FilterCheckbox( {handleFilterCheckbox, filterStorageStatus, handleSavedMoviesFilterCheckbox}) {
    ...
    useEffect(()=>{
        ...
        <label className='filter'>
            <input className='filter__switcher' type='checkbox' defaultChecked={moviesOnLocation ? filter : undefined} onChange={moviesOnLocation ? handleFilterCheckbox : handleSavedMoviesFilterCheckbox}/>
